	 ...
	 @Override
	   protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
	      ...
	      /*
	       ...
	       특정 페이지로 진입한 경우에는 파라미ㅓ를 받아서 구간을 계산해서 얻어옴
	       */
	      int pageNum = 1;
	      ...
	      //모델 1방식의 게시판에서 사용했던 메서드를 그대로 사용헌더
	      String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, "../mvcboard/list.do");
	      //View 로 전달 할 테이터를 Map컬렉션에 저장함.
	      //페이지 번호
	      ...
	      //View 로 전달할 객체들을 request 영역에 저장한다
	      req.setAttribute("boardLists", boardLists);
	      req.setAttribute("map", map);
	      //View로 포워드를 걸어준다.
	      req.getRequestDispatcher("/01sangwon/main/tables.jsp").forward(req, resp);
	   }
